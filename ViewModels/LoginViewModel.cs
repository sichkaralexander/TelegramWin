...
namespace TelegramWin.ViewModels
{
    public sealed class LoginViewModel : INotifyPropertyChanged
    {
        ...
        private AuthStep _step = AuthStep.Phone; // показываем телефон сразу
        private string _phone = "";
        private string _code = "";
        private string _password = "";
        private string _status = "Введите номер телефона";
        ...
        public async Task SendPhoneAsync() { IsBusy = true; try { await _td.SendPhoneAsync(Phone); } finally { IsBusy = false; } }
        public async Task SendCodeAsync() { IsBusy = true; try { await _td.SendCodeAsync(Code); } finally { IsBusy = false; } }
        public async Task SendPasswordAsync() { IsBusy = true; try { await _td.SendPasswordAsync(Password); } finally { IsBusy = false; } }
